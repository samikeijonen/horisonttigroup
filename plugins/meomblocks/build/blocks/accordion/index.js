...
const TEMPLATE = [['meomblocks/accordion-content'], ['meomblocks/accordion-content']];
function Edit(props) {
  const {
    attributes: {}
  } = props;
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/accordion/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/blocks/accordion/edit.js");
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"meomblocks/accordion","version":"0.1.0","title":"Haitari","category":"meomblocks","keywords":["accordion","haitari","meomblocks"],"icon":"align-pull-right","description":"Haitari, missä pidempi sisältö on piilotettu ja avautuu klikkaamalla.","attributes":{},"example":{},"supports":{"html":false,"spacing":{"margin":["top"]}},"textdomain":"meomblocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
